    ...
    <div className="my-10">
      <div className="text-center py-8 text-3xl">
        ...
        <p className="w-3/4 m-auto text-sm sm:test-sm md:text-base text-gray-600">
          ...
          similique molestias laudantium, perspiciatis velit facilis voluptate
          aut tempore sequi assumenda, non ab aliquam eum, quibusdam laborum
          quod officia veritatis.
        </p>
      </div>
      {/* Rendering Products */}
